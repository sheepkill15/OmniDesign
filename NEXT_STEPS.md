...
- Provider and model selection now persists on queued work and survives Retry. Both the home and design-workspace composers expose the development provider plus authenticated discovered provider models, and selected real-provider prompts create or update the managed design workspace through the queue.
